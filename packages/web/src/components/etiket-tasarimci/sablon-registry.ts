...
export const SABLONLAR: Array<SablonTanim & { Preview: ComponentType<PreviewProps> }> = [
  ...
  },
  {
    ...
    aciklama: 'Katlanır paddle · 102×20 mm (Güneş/Aksesuar ile aynı yapı) · GS1 DataMatrix + UTS kodları',
    etiketGenislik: 102,
    etiketYukseklik: 20,
    previewW: 306,
    previewH: 60,
    ...
    ozellestirmeAlanlari: [
      ...
      { key: 'gosterBarkod', label: 'Barkod (Code128) Göster', type: 'boolean' },
      { key: 'gosterGs1', label: 'GS1 DataMatrix Göster', type: 'boolean' },
      { key: 'gosterGs1Kodlari', label: 'GS1 Referans Satırları (UTS: Lot/Seri) Göster', type: 'boolean' },
    ],
  },
  {
    id: 'depo-kutu',
