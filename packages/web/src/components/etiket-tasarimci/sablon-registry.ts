...
export const SABLONLAR: Array<SablonTanim & { Preview: ComponentType<PreviewProps> }> = [
  {
    ...
    aciklama: "UTS'siz · Code128 barkod",
    etiketGenislik: 100,
    etiketYukseklik: 50,
    previewW: 300,
    previewH: 150,
  ...
  {
    id: 'depo-kutu',
    ad: 'Depo / Kutu Etiketi',
    aciklama: 'Büyük etiket · stok bilgili',
    etiketGenislik: 100,
    etiketYukseklik: 75,
    previewW: 300,
    previewH: 225,
    Preview: SABLON_PREVIEW_MAP['depo-kutu'],
    defaultAyar: { ...VARSAYILAN_AYAR, fontUrunAdi: 22, fontFiyat: 28 },
    ozellestirmeAlanlari: [
      ...ORTAK_ALANLAR,
      { key: 'gosterIcReferans', label: 'Referans Göster', type: 'boolean' },
      { key: 'gosterRenk', label: 'Renk Göster', type: 'boolean' },
      { key: 'gosterMiktar', label: 'Miktar Göster', type: 'boolean' },
      { key: 'gosterLokasyon', label: 'Lokasyon Göster', type: 'boolean' },
      { key: 'gosterLot', label: 'Lot No Göster', type: 'boolean' },
      { key: 'gosterBarkod', label: 'Barkod Göster', type: 'boolean' },
    ],
  },
  {
